...
public class Classifier {
    ...
    String [] dataSet = {"T-shirt/top", "Trouser", "Pullover", "Dress", "Coat", "Sandal", "Shirt", "Sneaker", "Bag", "Ankel boot"};
    ...
    public ByteBuffer loadModelFile(String modelName) throws IOException {
